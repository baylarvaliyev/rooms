    ...
    <div style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
      ...
      {callJoined && isMobile && dailyUrl && (
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
          <iframe
            src={`${dailyUrl}?t=${dailyToken}&embed=true&showLeaveButton=false`}
            allow="camera; microphone; autoplay; display-capture; fullscreen; speaker-selection"
            allowFullScreen
            style={{ flex: 1, border: 'none', width: '100%', height: '100%' }}
          />
          <div style={{ padding: '12px 16px', borderTop: '1px solid var(--border)', background: 'var(--bg1)', display: 'flex', justifyContent: 'center', flexShrink: 0, paddingBottom: 'max(12px, env(safe-area-inset-bottom))' }}>
